...
import analyImg from "../assets/history.png";
...
function Home() {
  ...
  return (
    <div className="min-h-scree bg-[#f3f3f3] flex flex-col">
      <Navbar />
      <div className="flex-1 px-6 py-20">
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-center mb-6">
            <div className="bg-gray-100 text-gray-600 text-sm px-4 py-2 rounded-full flex items-center gap-2">
              <Icon name="sparkle" size={16} className="bg-50 text-green-600" />
          ...
          <div className="text-center mb-28">
            ...
            <div className="flex flex-wrap  justify-center gap-4 mt-10">
              <motion.button
                ...
                className="bg-black text-white px-10 py-3 rounded-full hover:opactiy-90 transition shadow-md"
              >
                Start Interview
              </motion.button>
              <motion.button
                ...
                >
                  <div className="flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="w-full md:w-1/2">
                      <div
                        className="bg-green-50 text-green-600 w-12 h-12 rounded-xl 
