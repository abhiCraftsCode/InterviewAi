...
function Navbar() {
  ...
  return (
    <div className="flex justify-center pt-6 px-4 bg-[#f3f3f3]">
      <motion.div
        initial={{ opacity: 0, y: -40 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.4 }}
        className="w-full max-w-6xl bg-white rounded-[24px] shadow-sm border-gray-200 
      px-8 py-4 flex justify-between items-center relative"
      >
        <div className="flex items-center gap-3 curor-pointer">
        ...
        <div className="flex items-center gap-6 relative">
          <div className="relative">
            ...
            {showCreditPopup && (
              <div
                className="absolute right-[-50px] mt-3 w-64 bg-white shadow-xl border
            border-gray-200 rounded p-5 z-50"
              >
                <p className="text-sm test-gray-600 mb-4 ">
